# Python Interface - PyQt5/PyQt5(optional) (MODERN / FLAT GUI)

> ## :gift: **//// DONATE ////**
> ## 🔗 Donate (Gumroad): https://gum.co/mHsRC

> **Warning**: use PyQt5 and PyQt5 in version 5.15.2 or > (**pip install PyQt5==5.15.2**)!


![image_1](https://user-images.githubusercontent.com/60605512/82736094-50887300-9cfd-11ea-8e9a-c2fbbf97d983.PNG)

Project created using Python, Qt Designer and PyQt5.
...
> ```
> PyQt5 and PyQt5 in version 5.15.1 **are causing problems** due to several updates in process.
